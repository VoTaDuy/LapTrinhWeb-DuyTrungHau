...
<head>
    ...
    <style>
        .heading {
            ...
            gap: 1rem;
            background: linear-gradient(rgb(0 0 0 / 70%), rgba(0, 0, 0, .4)), url(../project/images/backgr3.png) no-repeat;
...
<body>
    ...
    <section class="about">
        ...
        <div class="flex">
            ...
            <div class="image">
                <img src="images/phone_review.jpg" alt="" width="450" height="450" style="opacity: 0.9;">
    ...
    <section class="reviews">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p>Mua sắm tại DTH Phone là 1 trải nghiệm tuyệt vời với tôi. Tôi ấn tượng với đội ngũ chuyên nghiệp của họ</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="box">
                ...
                <p>Tôi đã mua Điện thoại tại DTH phone cho cả gia đình và mọi người đều rất ưng ý. Giá cả hợp lý, chất lượng đảm bảo. Tôi rất mong đợi lần quay lại tiếp theo.</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
